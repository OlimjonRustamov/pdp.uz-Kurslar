...
class DbHelper(context: Context) : SQLiteOpenHelper(context, "pdpuz_kurslar", null, 1),DbMethods {
    override fun onCreate(db: SQLiteDatabase?) {
        val create_barcha_kurslar="CREATE TABLE `barcha_kurslar` (`id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE,`kurs_nomi` TEXT NOT NULL,`kurs_haqida` TEXT NOT NULL)"
